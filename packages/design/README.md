...
export default defineConfig({
  ...
  // `pipeline.include` REPLACES UnoCSS's default scan — adding only this regex
  // stops your own `.vue`/`.tsx` from being scanned. Add the package alongside the
  // defaults, e.g. `include: ['src/**/*.{vue,ts,tsx}', /@antfu\/design/]`.
...
generated by adding `/@antfu\/design/` to `content.pipeline.include`. **Note:**
setting `include` *replaces* UnoCSS's default scan, so list your own sources
alongside it (`include: ['src/**/*.{vue,ts,tsx}', /@antfu\/design/]`) or your app's
own utilities will stop being generated.
