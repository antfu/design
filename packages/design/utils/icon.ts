...
export const defaultFileIconRules: FileIconRule[] = [
  { match: /\.vue$/, name: 'vue', icon: 'i-catppuccin:vue icon-catppuccin' },
  { match: /\.tsx$/, name: 'tsx', icon: 'i-catppuccin:typescript-react icon-catppuccin' },
  { match: /\.jsx$/, name: 'jsx', icon: 'i-catppuccin:javascript-react icon-catppuccin' },
  { match: /\.d\.[cm]?ts$/, name: 'dts', icon: 'i-catppuccin:typescript-def icon-catppuccin' },
  { match: /\.[cm]?ts$/, name: 'ts', icon: 'i-catppuccin:typescript icon-catppuccin' },
  { match: /\.[cm]?js$/, name: 'js', icon: 'i-catppuccin:javascript icon-catppuccin' },
  { match: /\.json5?$/, name: 'json', icon: 'i-catppuccin:json icon-catppuccin' },
  { match: /\.ya?ml$/, name: 'yaml', icon: 'i-catppuccin:yaml icon-catppuccin' },
  { match: /\.toml$/, name: 'toml', icon: 'i-catppuccin:toml icon-catppuccin' },
  { match: /\.md$/, name: 'markdown', icon: 'i-catppuccin:markdown icon-catppuccin' },
  { match: /\.html?$/, name: 'html', icon: 'i-catppuccin:html icon-catppuccin' },
  { match: /\.(?:css|postcss)$/, name: 'css', icon: 'i-catppuccin:css icon-catppuccin' },
  { match: /\.s[ac]ss$/, name: 'sass', icon: 'i-catppuccin:sass icon-catppuccin' },
  { match: /\.svg$/, name: 'svg', icon: 'i-catppuccin:svg icon-catppuccin' },
  { match: /\.(?:png|jpe?g|gif|webp|avif|ico)$/, name: 'image', icon: 'i-catppuccin:image icon-catppuccin' },
  { match: /\.(?:woff2?|ttf|otf|eot)$/, name: 'font', icon: 'i-catppuccin:font icon-catppuccin' },
  { match: /\.wasm$/, name: 'wasm', icon: 'i-catppuccin:webassembly icon-catppuccin' },
  { match: /package\.json$/, name: 'npm', icon: 'i-catppuccin:npm icon-catppuccin' },
  { match: /\.(?:test|spec)\.[cm]?[jt]sx?$/, name: 'test', icon: 'i-catppuccin:typescript-test icon-catppuccin' },
]
